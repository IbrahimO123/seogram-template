        ...
        <div className="my-3" >
                 <div className="container" >
                     <div className="row mt-5" >
                      ...
                      <p className="card-img img-fluid img-top blog-img" > <img style={blogImg} src={blog4} alt="service3.svg"></img></p>
                     ...
                     <div className="col-lg-4 py-3" >
                      ...
                      <p className="card-img img-fluid img-top blog-img" > <img style={blogImg} src={blog5} alt="service3.svg"></img></p>
                        <div className="card-body">
                          <h5 className="card-title text-secondary " >Source of Content Inspiration</h5>
                          <div className="card-link text-muted post-date" >Posted on <a href="##" className="text-decoration-none" >27 Jan 2020</a></div>
                        </div>
                      ...
                      <div className="col-lg-4 py-3" >
                      <div className="card border border-light box blog" style={boxstyle1}>
                      <p className="card-img img-fluid img-top blog-img" > <img style={blogImg} src={blog6} alt="service3.svg"></img></p>
                          <div className="card-body" >
                            <h5 className="card-title text-secondary" >Source of Content Inspiration</h5>
                            <div className="card-link text-muted post-date" >Posted on <a href="##" className="text-decoration-none" >27 Jan 2020</a></div>
                          </div>
