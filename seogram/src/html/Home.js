    ...
    return (
        ...
        <div  className="container" >
            ...
            <div className="row align-items-center flex-wrap-reverse h-100" >
             <div  className="col-md-6 py-5 wow animate__animated animate__fadeInLeft">
        ...
        {/****************Our Services Check *******************/}
            <div className="services w-100 text-center py-5 " >
                <div className="services py-5 wow animate__animated animate__fadeInUp" style={styleService} >
        ...
        {/******************* Visibility SEO ********************/}
            ...
            <div className="col-lg-6 py-3 pr-lg-5 wow animate__animated animate__fadeInUp">
                       <div>
